...
public class NewestResourcesDecorator implements ILightweightLabelDecorator {
    public static final String ID = "esee.ui.newsdecorator";
    public static final QualifiedName decorationTypeProperty = new QualifiedName("esee.ui.decorator", "newest");
