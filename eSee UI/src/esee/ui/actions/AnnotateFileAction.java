...
import esee.ui.markers.EseeQuickDiffProvider;
import esee.ui.markers.RevMarker;
import esee.ui.markers.RevisionAnnotation;
import esee.ui.util.EseeUIUtil;
...
public class AnnotateFileAction {
    ...
    private static final QualifiedName MARKED_REV_VERSION_PROP = new QualifiedName("esee.ui", "annotatedCacheVersion");
    private static final String CACHED_REVISION_INFORMATION_KEY = "esee.ui.revInfoKey";
